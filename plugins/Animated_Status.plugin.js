...
const GUI = {
  newInput: (text = "", placeholder = "") => {
    ...
    input.className = "inputDefault_f8bc55 input_f8bc55";
  ...
  newLabel: (text = "") => {
    ...
    label.className = "h5_c46f6a eyebrow_c46f6a";
  ...
  newButton: (text, filled = true) => {
    ...
    button.className = "button_dd4f85 colorBrand_dd4f85 sizeMedium_dd4f85 grow_dd4f85";
    if (filled) button.classList.add("lookFilled_dd4f85");
    else button.classList.add("lookOutlined_dd4f85");
  ...
  setSuggested: (element, value = true) => {
    if (value) element.classList.add("colorGreen_dd4f85");
    else element.classList.remove("colorGreen_dd4f85");
    return element;
  },

  setDestructive: (element, value = true) => {
    if (value) element.classList.add("colorRed_dd4f85");
    else element.classList.remove("colorRed_dd4f85");
    return element;
  }
};
